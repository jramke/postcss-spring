...
test("generates correct easing curve", async () => {
    await run(
        ...
        `.my-box { transition-timing-function: var(${CSS_VAR_PREFIX}-easing-0); ${CSS_VAR_PREFIX}-easing-0: linear(0, 0.001 0.44%, 0.0045 0.94%, 0.0195 2.03%, 0.0446 3.19%, 0.0811 4.5%, 0.1598 6.82%, 0.3685 12.34%, 0.4693 15.17%, 0.5663, 0.6498 21.27%, 0.7215 24.39%, 0.7532 25.98%, 0.7829 27.65%, 0.8105, 0.8349 31.14%, 0.8573 32.95%, 0.8776 34.84%, 0.8964 36.87%, 0.9136 39.05%, 0.929 41.37%, 0.9421 43.77%, 0.9537 46.38%, 0.9636 49.14%, 0.9789 55.31%, 0.9888 62.35%, 0.9949 71.06%, 0.9982 82.52%, 0.9997 99.94%); ${CSS_VAR_PREFIX}-duration-multiplier-0: 1.66 }@supports not (transition-timing-function: linear(0, 1)) {.my-box { ${CSS_VAR_PREFIX}-easing-0: ease; ${CSS_VAR_PREFIX}-duration-multiplier-0: 1 } }`, 
        {}
    );
});
...
test("generates correct duration", async () => {
    await run(
        ...
        `.my-box { transition-duration: calc(var(${CSS_VAR_PREFIX}-duration-0) * var(${CSS_VAR_PREFIX}-duration-multiplier-0)); ${CSS_VAR_PREFIX}-duration-0: 100ms }`, 
        {}
    );
});
...
test("generates correct arbitrary duration", async () => {
    await run(
        ...
        `.my-box { transition-duration: calc(var(${CSS_VAR_PREFIX}-duration-0) * var(${CSS_VAR_PREFIX}-duration-multiplier-0)); ${CSS_VAR_PREFIX}-duration-0: 77ms }`, 
        {}
    );
});
...
test("handles transition with spring-duration and spring-bounce", async () => {
    await run(
        ...
        `.my-box { transition: transform calc(var(${CSS_VAR_PREFIX}-duration-0) * var(${CSS_VAR_PREFIX}-duration-multiplier-0)) var(${CSS_VAR_PREFIX}-easing-0); ${CSS_VAR_PREFIX}-easing-0: linear(0, 0.0018, 0.0069, 0.0151 1.74%, 0.0277 2.4%, 0.062 3.7%, 0.1115 5.15%, 0.2211 7.77%, 0.4778 13.21%, 0.5912 15.75%, 0.6987 18.44%, 0.7862 20.98%, 0.861 23.59%, 0.8926, 0.9205, 0.945 27.51%, 0.9671 28.89%, 0.9868, 1.003 31.79%, 1.0224 34.11%, 1.0358 36.58%, 1.0436 39.27%, 1.046 42.31%, 1.0446 44.71%, 1.0406 47.47%, 1.0118 61.84%, 1.0027 69.53%, 0.9981 80.49%, 0.9991 99.94%); ${CSS_VAR_PREFIX}-duration-multiplier-0: 1.66; ${CSS_VAR_PREFIX}-duration-0: 200ms }@supports not (transition-timing-function: linear(0, 1)) {.my-box { ${CSS_VAR_PREFIX}-easing-0: ease; ${CSS_VAR_PREFIX}-duration-multiplier-0: 1 } }`,
        {}
    );
});
...
test("handles animation with spring-duration and spring-bounce", async () => {
    await run(
        ...
        `.my-box { animation: my-animation calc(var(${CSS_VAR_PREFIX}-duration-0) * var(${CSS_VAR_PREFIX}-duration-multiplier-0)) var(${CSS_VAR_PREFIX}-easing-0); ${CSS_VAR_PREFIX}-easing-0: linear(0, 0.0018, 0.0069, 0.0151 1.74%, 0.0277 2.4%, 0.062 3.7%, 0.1115 5.15%, 0.2211 7.77%, 0.4778 13.21%, 0.5912 15.75%, 0.6987 18.44%, 0.7862 20.98%, 0.861 23.59%, 0.8926, 0.9205, 0.945 27.51%, 0.9671 28.89%, 0.9868, 1.003 31.79%, 1.0224 34.11%, 1.0358 36.58%, 1.0436 39.27%, 1.046 42.31%, 1.0446 44.71%, 1.0406 47.47%, 1.0118 61.84%, 1.0027 69.53%, 0.9981 80.49%, 0.9991 99.94%); ${CSS_VAR_PREFIX}-duration-multiplier-0: 1.66; ${CSS_VAR_PREFIX}-duration-0: 200ms }@supports not (transition-timing-function: linear(0, 1)) {.my-box { ${CSS_VAR_PREFIX}-easing-0: ease; ${CSS_VAR_PREFIX}-duration-multiplier-0: 1 } }`,
        {}
    );
});
...
test("handles multiple transition values", async () => {
    await run(
        ...
        `.my-box { transition: transform calc(var(--postcss-spring-duration-0) * var(--postcss-spring-duration-multiplier-0)) var(--postcss-spring-easing-0), scale calc(var(--postcss-spring-duration-1) * var(--postcss-spring-duration-multiplier-1)) var(--postcss-spring-easing-1); --postcss-spring-easing-0: linear(0, 0.001 0.44%, 0.0045 0.94%, 0.0195 2.03%, 0.0446 3.19%, 0.0811 4.5%, 0.1598 6.82%, 0.3685 12.34%, 0.4693 15.17%, 0.5663, 0.6498 21.27%, 0.7215 24.39%, 0.7532 25.98%, 0.7829 27.65%, 0.8105, 0.8349 31.14%, 0.8573 32.95%, 0.8776 34.84%, 0.8964 36.87%, 0.9136 39.05%, 0.929 41.37%, 0.9421 43.77%, 0.9537 46.38%, 0.9636 49.14%, 0.9789 55.31%, 0.9888 62.35%, 0.9949 71.06%, 0.9982 82.52%, 0.9997 99.94%); --postcss-spring-easing-1: linear(0, 0.0029, 0.0115, 0.0255, 0.0453, 0.0714, 0.1025 1.95%, 0.1844 2.68%, 0.2681 3.31%, 0.371 4%, 0.768 6.45%, 0.919, 1.054 8.41%, 1.1624 9.34%, 1.208, 1.247, 1.2816, 1.3097, 1.3325, 1.3504, 1.3629, 1.3702 12.98%, 1.3722, 1.3716, 1.3683, 1.3625 14.36%, 1.3431 15.1%, 1.3123 15.89%, 1.2805 16.56%, 1.2392 17.32%, 1.0838 19.9%, 1.0257, 0.9748 21.93%, 0.9348 22.87%, 0.9056, 0.884, 0.8696, 0.8624 26.32%, 0.8614, 0.8635 27.54%, 0.8686 28.18%, 0.877 28.86%, 0.8882 29.57%, 0.9029 30.34%, 0.9824 33.93%, 1.0156 35.7%, 1.0299 36.7%, 1.0404, 1.0475, 1.0511 39.64%, 1.0509 40.89%, 1.0459 42.26%, 1.036 43.76%, 1.0067 47.32%, 0.9945 49.06%, 0.9852, 0.9811 52.93%, 0.9829 55.66%, 1.0019 62.39%, 1.007 66.13%, 1.0064 69.05%, 0.9994 75.69%, 0.9974 79.29%, 1.0009 91.8%, 1.0003 100%); --postcss-spring-duration-multiplier-0: 1.66; --postcss-spring-duration-multiplier-1: 3.91; --postcss-spring-duration-0: 200ms; --postcss-spring-duration-1: 400ms }@supports not (transition-timing-function: linear(0, 1)) {.my-box { --postcss-spring-easing-0: ease; --postcss-spring-easing-1: ease; --postcss-spring-duration-multiplier-0: 1; --postcss-spring-duration-multiplier-1: 1 } }`,
        {}
    );
});
...
test("handles separate transition-duration and transition-timing-function", async () => {
    await run(
        ...
        `.my-box { transition-duration: calc(var(--postcss-spring-duration-0) * var(--postcss-spring-duration-multiplier-0)), calc(var(--postcss-spring-duration-1) * var(--postcss-spring-duration-multiplier-1)); transition-property: transform, scale; transition-timing-function: var(--postcss-spring-easing-0), var(--postcss-spring-easing-1); --postcss-spring-duration-0: 200ms; --postcss-spring-duration-1: 200ms; --postcss-spring-easing-0: linear(0, 0.001 0.44%, 0.0045 0.94%, 0.0195 2.03%, 0.0446 3.19%, 0.0811 4.5%, 0.1598 6.82%, 0.3685 12.34%, 0.4693 15.17%, 0.5663, 0.6498 21.27%, 0.7215 24.39%, 0.7532 25.98%, 0.7829 27.65%, 0.8105, 0.8349 31.14%, 0.8573 32.95%, 0.8776 34.84%, 0.8964 36.87%, 0.9136 39.05%, 0.929 41.37%, 0.9421 43.77%, 0.9537 46.38%, 0.9636 49.14%, 0.9789 55.31%, 0.9888 62.35%, 0.9949 71.06%, 0.9982 82.52%, 0.9997 99.94%); --postcss-spring-easing-1: linear(0, 0.0029, 0.0115, 0.0255, 0.0453, 0.0714, 0.1025 1.95%, 0.1844 2.68%, 0.2681 3.31%, 0.371 4%, 0.768 6.45%, 0.919, 1.054 8.41%, 1.1624 9.34%, 1.208, 1.247, 1.2816, 1.3097, 1.3325, 1.3504, 1.3629, 1.3702 12.98%, 1.3722, 1.3716, 1.3683, 1.3625 14.36%, 1.3431 15.1%, 1.3123 15.89%, 1.2805 16.56%, 1.2392 17.32%, 1.0838 19.9%, 1.0257, 0.9748 21.93%, 0.9348 22.87%, 0.9056, 0.884, 0.8696, 0.8624 26.32%, 0.8614, 0.8635 27.54%, 0.8686 28.18%, 0.877 28.86%, 0.8882 29.57%, 0.9029 30.34%, 0.9824 33.93%, 1.0156 35.7%, 1.0299 36.7%, 1.0404, 1.0475, 1.0511 39.64%, 1.0509 40.89%, 1.0459 42.26%, 1.036 43.76%, 1.0067 47.32%, 0.9945 49.06%, 0.9852, 0.9811 52.93%, 0.9829 55.66%, 1.0019 62.39%, 1.007 66.13%, 1.0064 69.05%, 0.9994 75.69%, 0.9974 79.29%, 1.0009 91.8%, 1.0003 100%); --postcss-spring-duration-multiplier-0: 1.66; --postcss-spring-duration-multiplier-1: 3.91 }@supports not (transition-timing-function: linear(0, 1)) {.my-box { --postcss-spring-easing-0: ease; --postcss-spring-easing-1: ease; --postcss-spring-duration-multiplier-0: 1; --postcss-spring-duration-multiplier-1: 1 } }`,
        {}
    );
});

test("handles invalid bounce values", async () => {
    runError(".my-box { transition-duration: spring-bounce(-20) }", "Negative bounce values are not allowed");
...
test("handles invalid duration values", async () => {
    runError(".my-box { transition-duration: spring-duration(-100) }", "Negative duration values are not allowed");
